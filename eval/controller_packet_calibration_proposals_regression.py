...
def main() -> int:
    ...
    checks = {
        ...
        "proposal_count": report["proposal_count"] == 6,
        "promotion_candidate_count": report["promotion_candidate_count"] == 2,
        "review_item_count": report["review_item_count"] == 4,
        ...
        "ogcf_bridge_candidate_present": "ogcf_bridge_behavior_candidate" in kinds,
        "ogcf_false_positive_is_review": any(
            item["kind"] == "negative_feedback_review"
            and "ogcf_false_positive" in item.get("feedback_labels", {})
