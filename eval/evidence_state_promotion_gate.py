...
OUT_JSON = REPO_ROOT / "experiments" / "evidence_state_promotion_gate_results.json"
OUT_MD = REPO_ROOT / "experiments" / "evidence_state_promotion_gate_report.md"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the evidence-state promotion gate.")
