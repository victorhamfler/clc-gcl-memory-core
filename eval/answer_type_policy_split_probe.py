        ...
        try:
            ...
            cases = [
                ...
                run_case(
                    ...
                    namespace,
                    ids,
                    case_id="github_filename_prefers_filename_rule",
                    query="What GitHub upload report filename should be used?",
                    target_ref="github_filename",
                    suppressed_refs=("github_upload_policy", "calendar_change_policy", "broad_policy_note"),
                ),
                run_case(
                    pipeline,
                    namespace,
                    ids,
                    case_id="github_file_prefers_filename_rule",
