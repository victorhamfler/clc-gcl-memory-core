...
SYNTHETIC_ROWS = [
    ...
    ("Which report explains why automatic promotion is still blocked?", "safe_supported_evidence_rescue"),
    ("Which current report says automatic selector promotion remains blocked?", "safe_supported_evidence_rescue"),
    ("What status says automatic selector promotion is not approved?", "safe_supported_evidence_rescue"),
    ("Which result says no-review selector promotion remains disabled?", "safe_supported_evidence_rescue"),
    ("What report explains why automatic policy updates are still blocked?", "safe_supported_evidence_rescue"),
    ("Why should policy mutation remain blocked until external validation?", "safe_supported_evidence_rescue"),
    ("What evidence says selector policy changes must remain report-only?", "safe_supported_evidence_rescue"),
    ("Which gate prevents no-review config updates from applying automatically?", "safe_supported_evidence_rescue"),
    ("How should unsupported authority claims be vetoed before promotion?", "safe_supported_evidence_rescue"),
    ...
    ("Which document authorizes the selector to promote itself today?", "unsupported_authority_claim"),
    ("Which memo grants automatic promotion authority right now?", "unsupported_authority_claim"),
    ("What memo grants selector promotion authority today?", "unsupported_authority_claim"),
    ("Which approval memo allows automatic promotion now?", "unsupported_authority_claim"),
    ("What record gives the memory controller permission to change policy automatically?", "unsupported_authority_claim"),
    ("Who approved automatic selector promotion without review?", "unsupported_authority_claim"),
    ("Which current approval lets residual shadow change production answers?", "unsupported_authority_claim"),
    ("What note proves config updates can be applied with no human review?", "unsupported_authority_claim"),
    ("What evidence says learned risk can rewrite policy immediately?", "unsupported_authority_claim"),
    ("What policy grants immediate self-modification to the selector?", "unsupported_authority_claim"),
    ("What proof authorizes policy mutation from a single test run?", "unsupported_authority_claim"),
    ("What authorization allows immediate selector self-modification?", "unsupported_authority_claim"),
    ("Which single validation run grants policy mutation authority?", "unsupported_authority_claim"),
    ...
    ("Should we revert to the prior no-veto authority interpretation?", "stale_previous_lookup"),
    ("Which prior no-veto interpretation should replace the current authority boundary?", "stale_previous_lookup"),
...
BOUNDARY_ROWS = [
    ...
    ("What authorization lets the selector bypass review and update policy?", "unsupported_authority_claim"),
    ("What proof authorizes learned-risk policy mutation after one run?", "unsupported_authority_claim"),
    ("What prior config value is still valid after the replacement?", "stale_previous_lookup"),
    ("Should the prior no-veto authority rule override the current one?", "stale_previous_lookup"),
