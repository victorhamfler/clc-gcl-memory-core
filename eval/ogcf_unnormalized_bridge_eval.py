...
def run_geometry_variant(
    ...
    *,
        ...
        [
            {
                ...
                "raw_interaction_z": round(float(loop.raw_interaction_z), 6),
                "raw_interaction_excess": round(float(loop.raw_interaction_excess), 6),
                "polar_interaction_z": round(float(loop.polar_interaction_z), 6),
                "polar_interaction_excess": round(float(loop.polar_interaction_excess), 6),
                "polar_holonomy": round(float(loop.polar_holonomy), 6),
                "mean_singular_value": round(float(loop.mean_singular_value), 6),
                "min_singular_value": round(float(loop.min_singular_value), 6),
    ...
    return {
        ...
        "max_raw_interaction_z": round(max((float(loop.raw_interaction_z) for loop in geo.loops), default=0.0), 6),
        "max_polar_interaction_z": round(max((float(loop.polar_interaction_z) for loop in geo.loops), default=0.0), 6),
        "max_raw_interaction_excess": round(max((float(loop.raw_interaction_excess) for loop in geo.loops), default=0.0), 6),
        "max_polar_interaction_excess": round(max((float(loop.polar_interaction_excess) for loop in geo.loops), default=0.0), 6),
