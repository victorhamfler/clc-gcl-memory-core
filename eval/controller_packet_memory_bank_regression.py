...
def packet(idx: int, *, label: str, rating: float, would_override: bool = False) -> dict:
    return {
...
def main() -> int:
    ...
    checks = {
        ...
        "packet_count": report["packet_count"] == 3,
        "cluster_count": report["cluster_count"] == 2,
        ...
        "tracks_residual_packets": report["residual_packet_count"] == 3,
